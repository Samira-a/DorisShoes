<?php /* Smarty version Smarty-3.0.7, created on 2012-02-02 23:29:45
         compiled from "/home/a2012616/public_html/themes/theme138/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21035627154f2b0049495d46-31080454%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd04b55d710dd9dd5779d05723faf8b0af0d9f230' => 
    array (
      0 => '/home/a2012616/public_html/themes/theme138/contact-form.tpl',
      1 => 1327934617,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21035627154f2b0049495d46-31080454',
  'function' => 
  array (
  ),
...
icon/home.png"/></a><a href="<?php echo $_smarty_tpl->getVariable('base_dir')->value;?>
...
" readonly="readonly" />
			...
			<label for="id_product"><?php echo smartyTranslate(array('s'=>'Product'),$_smarty_tpl);?>
				...
				<?php if (!isset($_smarty_tpl->getVariable('customerThread',null,true,false)->value['id_product'])){?>
					<select name="id_product"><option value="0"><?php echo smartyTranslate(array('s'=>'-- Choose --'),$_smarty_tpl);?>
...
" readonly="readonly" />
		...
		<p class="textarea">
			<label for="message"><?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
			 ...
			 <textarea id="message" name="message" rows="15" cols="20"><?php if (isset($_smarty_tpl->getVariable('message',null,true,false)->value)){?><?php echo stripslashes(smarty_modifier_escape($_smarty_tpl->getVariable('message')->value,'htmlall','UTF-8'));?>
<?php }?></textarea>
		</p>
		<p class="submit">
