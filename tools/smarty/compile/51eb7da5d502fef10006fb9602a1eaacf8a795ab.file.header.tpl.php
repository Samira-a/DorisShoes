<?php /* Smarty version Smarty-3.0.7, created on 2012-02-07 20:57:32
         compiled from "/home/a2012616/public_html/themes/theme138/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10882250544f31741c765aa3-83346029%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51eb7da5d502fef10006fb9602a1eaacf8a795ab' => 
    array (
      0 => '/home/a2012616/public_html/themes/theme138/header.tpl',
      1 => 1327934618,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10882250544f31741c765aa3-83346029',
  'function' => 
  array (
  ),
...
<?php if (isset($_smarty_tpl->getVariable('ad',null,true,false)->value)&&isset($_smarty_tpl->getVariable('live_edit',null,true,false)->value)){?><?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."./live_edit.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?><?php }?>
<?php if (!$_smarty_tpl->getVariable('content_only')->value){?>
<?php if (isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)&&$_smarty_tpl->getVariable('restricted_country_mode')->value){?><div id="restricted-country"><p><?php echo smartyTranslate(array('s'=>'You cannot place a new order from your country.'),$_smarty_tpl);?>
...
logo.jpg?<?php echo $_smarty_tpl->getVariable('time')->value;?>
