<?php /* Smarty version Smarty-3.0.7, created on 2012-02-12 19:28:27
         compiled from "/home/a2585048/public_html/themes/theme138/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17254417594f37f6bb54bbd4-26113532%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33e977d0eae6f9e85da974e0553f80ff9fbb836a' => 
    array (
      0 => '/home/a2585048/public_html/themes/theme138/product.tpl',
      1 => 1328655514,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17254417594f37f6bb54bbd4-26113532',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_date_format')) include '/home/a2585048/public_html/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/a2585048/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/a2585048/public_html/tools/smarty/plugins/function.counter.php';
...
" />
		...
		<?php }?>
		<?php if (isset($_smarty_tpl->getVariable('images',null,true,false)->value)&&count($_smarty_tpl->getVariable('images')->value)>1){?><span id="wrapResetImages" style="display:none;"><div><a id="resetImages" href="<?php echo $_smarty_tpl->getVariable('link')->value->getProductLink($_smarty_tpl->getVariable('product')->value);?>
	...
	<div id="pb-left-column">
		...
		<div id="short_description_block">
			<?php if ($_smarty_tpl->getVariable('product')->value->description_short){?>
				<div id="short_description_content" class="rte align_justify"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->getVariable('product')->value->description_short),250,'...');?>
</div>
			<?php }?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['packItem']->value['name'],'htmlall','UTF-8');?>
						...
						<p><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['packItem']->value['description_short'],100,'...');?>
</p>
					</div>
				<?php }} ?>
			<?php }?>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for green tax'),$_smarty_tpl);?>
						...
						<?php if ($_smarty_tpl->getVariable('product')->value->specificPrice&&$_smarty_tpl->getVariable('product')->value->specificPrice['reduction']){?><br /><?php echo smartyTranslate(array('s'=>'(not impacted by the discount)'),$_smarty_tpl);?>
<?php }?>
					</p>
					<?php }?>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->getVariable('product')->value->online_only){?><p class="online_only"><?php echo smartyTranslate(array('s'=>'Online only'),$_smarty_tpl);?>
!</p><?php }?>
...
<!-- quantity discount -->
<ul class="idTabs">
	<li><a class="selected"><?php echo smartyTranslate(array('s'=>'Quantity discount'),$_smarty_tpl);?>
</a></li>
</ul>
...
<div id="more_info_block" class="clear">
	...
	<?php if ($_smarty_tpl->getVariable('product')->value->description){?>
		<!-- full description -->
		<div id="idTab1"><?php echo $_smarty_tpl->getVariable('product')->value->description;?>
</div>
	<?php }?>
...
?>
			...
			<li class="ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']){?>last_item<?php }else{ ?>item<?php }?> product_accessories_description">
				<div class="accessories_desc">
					<a class="accessory_image product_img_link" href="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('accessoryLink')->value,'htmlall','UTF-8');?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessory']->value['legend'],'htmlall','UTF-8');?>
"><img src="<?php echo $_smarty_tpl->getVariable('link')->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'medium');?>
" alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessory']->value['legend'],'htmlall','UTF-8');?>
" /></a>
					<h5><a class="product_link" href="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('accessoryLink')->value,'htmlall','UTF-8');?>
"><?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['accessory']->value['name'],22,'...',true),'htmlall','UTF-8');?>
</a></h5>
					<a class="product_descr" href="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('accessoryLink')->value,'htmlall','UTF-8');?>
" title="<?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),70,'...');?>
</a>
				</div>
...
icon/infos.png" alt="Informations" />
