<?php /* Smarty version Smarty-3.0.7, created on 2012-02-01 07:14:30
         compiled from "/home/a2012616/public_html/themes/theme138/products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4522975284f28ca369c6ef7-77067654%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '58f6a939ffb292a75653ac8971140223edb213dd' => 
    array (
      0 => '/home/a2012616/public_html/themes/theme138/products-comparison.tpl',
      1 => 1327934623,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4522975284f28ca369c6ef7-77067654',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_replace')) include '/home/a2012616/public_html/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_cycle')) include '/home/a2012616/public_html/tools/smarty/plugins/function.cycle.php';
...
%" class="ajax_block_product">
			<h5><a class="product_link" href="<?php echo $_smarty_tpl->getVariable('product')->value->getLink();?>
" title="<?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->getVariable('product')->value->name,30,'...'),'htmlall','UTF-8');?>
"><?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->getVariable('product')->value->name,25,'...'),'htmlall','UTF-8');?>
</a></h5>
			<p class="product_desc"><a class="product_descr" href="<?php echo $_smarty_tpl->getVariable('product')->value->getLink();?>
" title="<?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->getVariable('product')->value->description_short),120,'...');?>
</a></p>
...
" class="product_image" >
				<img src="<?php echo $_smarty_tpl->getVariable('link')->value->getImageLink($_smarty_tpl->getVariable('product')->value->link_rewrite,$_smarty_tpl->getVariable('product')->value->id_image,'medium');?>
...
" />
			...
			<?php if (isset($_smarty_tpl->getVariable('product',null,true,false)->value->show_price)&&$_smarty_tpl->getVariable('product')->value->show_price&&!isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?>
				<p><span class="price"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->getVariable('product')->value->getPrice($_smarty_tpl->getVariable('taxes_behavior')->value)),$_smarty_tpl);?>
</span></p>
...
"><?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
				...
				<?php if ((!$_smarty_tpl->getVariable('product')->value->hasAttributes()||(isset($_smarty_tpl->getVariable('add_prod_display',null,true,false)->value)&&($_smarty_tpl->getVariable('add_prod_display')->value==1)))&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?>
					<?php if (($_smarty_tpl->getVariable('product')->value->quantity>0||$_smarty_tpl->getVariable('product')->value->allow_oosp)&&$_smarty_tpl->getVariable('product')->value->customizable!=2){?>
...
cart.php?qty=1&amp;id_product=<?php echo $_smarty_tpl->getVariable('product')->value->id;?>
